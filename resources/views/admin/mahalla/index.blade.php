        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> {{$item->title}}  </td>
                    <td>
                        <a class="btn btn-sm btn-white float-left " href="{{route('admin.mahalla.show', $item->id)}}">
                            <i class="fa fa-eye"></i>
                        </a>
                        
                        <a class="btn float-left btn-sm btn-white" href="{{route('admin.mahalla.edit', ['id' => $item-> id])}}">
