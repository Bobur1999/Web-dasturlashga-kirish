@extends('layouts/admin', ['title' => "ADMIN -> Sport yangiliklari"])
@section('content')
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            <a href="{{route('admin.sport.show', $item->id)}}" class="btn btn-primary">
                            ...
                            <div class="btn-group" role="group">
                              ...
                              <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                <a class="dropdown-item" href="{{route('admin.sport.edit', ['id' => $item-> id])}}">
